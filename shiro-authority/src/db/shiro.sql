...
insert into users(username, password, password_salt) values('mapros', '984138', null);
insert into user_roles(username, role_name) values('mapros', 'role1');
insert into user_roles(username, role_name) values('mapros', 'role2');
